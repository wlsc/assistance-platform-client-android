...
import de.tudarmstadt.informatik.tk.assistance.adapter.PermissionAdapter.ViewHolder;
 ...
 * @date 09.11.2015
 */
public class PermissionAdapter extends Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(layout.item_permission, viewGroup, false);
    ...
    protected static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(id.permission_item_title)
        protected AppCompatTextView mTitle;

        @BindView(id.permission_item_switcher)
